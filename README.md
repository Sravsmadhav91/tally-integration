...
| [`AGENTS.md`](./AGENTS.md) · [`CLAUDE.md`](./CLAUDE.md) | **Standing brief the AI reads automatically** when you open the repo — the safety rules (draft-don't-post, don't hang Tally, no real data), the workflow, and where everything is. |
